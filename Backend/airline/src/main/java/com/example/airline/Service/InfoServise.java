...
public class InfoServise {
    ...
    public JSONObject getinfo(String token){
        ...
        if(id!=-1){
            ...
            js.put("name",clients.getName());
            js.put("surname",clients.getSurname());
            js.put("lastname",clients.getLastname());
            js.put("email",clients.getEmail());
            js.put("phone",clients.getPhone());
            js.put("serpass",clients.getSerpass());
            js.put("numberpass",clients.getNumberpass());
            js.put("password",clients.getPassword());
